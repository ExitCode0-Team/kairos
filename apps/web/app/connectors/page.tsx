...
function LinearIcon() {
  return (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" opacity={0.5}>
      <path d="M3.715 3.715a12.007 12.007 0 0 1 16.57 0 .75.75 0 0 1 0 1.06l-7.025 7.025a.75.75 0 0 1-1.06 0L5.175 4.775a.75.75 0 0 1 0-1.06zm-.965.965a.75.75 0 0 1 0 1.06L9.775 12.765a.75.75 0 0 0 0 1.06l7.025 7.025a.75.75 0 0 1-1.06 0 12.007 12.007 0 0 1-12.99-16.17z" />
    </svg>
  );
}
  ...
  return (
    <div
      className={cn(
        ...
        isChannel && !comingSoon && "cursor-pointer hover:border-border-hover",
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-3">
          <div className={cn(
            "w-10 h-10 rounded-[8px] bg-main border border-border flex items-center justify-center text-text-primary shrink-0",
        ...
        {!isChannel && !comingSoon && (
          connected ? (
            <Button variant="ghost" size="sm" onClick={onDisconnect} className="text-text-secondary hover:text-text-primary">
              <X className="w-4 h-4" />
            </Button>
          ) : (
...
const comingSoonSources = [
  {
    id: "slack-workspace",
    icon: <SlackWorkspaceIcon />,
    name: "Slack workspace",
    description: "Import work context from Slack.",
    comingSoon: true,
  },
  {
    id: "linear",
    icon: <LinearIcon />,
    name: "Linear",
    description: "Sync your project contributions.",
    comingSoon: true,
  },
  {
    id: "jira",
    icon: <JiraIcon />,
    name: "Jira",
    description: "Import your work history.",
    comingSoon: true,
  },
];
...
export default function ConnectorsPage() {
  const [connectedSources, setConnectedSources] = useState<string[]>(["notion", "github", "cv"]);
